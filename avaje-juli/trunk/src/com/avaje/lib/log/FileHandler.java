 ...
 * com.avaje.lib.log.AuxFileHandler.pattern=mylog.log
 * 
 * #daily rotating, in logs subdirectoy
 * com.avaje.lib.log.AuxFileHandler.pattern=logs/mylog%d.log
 * 
 * #daily rotating, in java.io.temp directory
 * com.avaje.lib.log.AuxFileHandler.pattern=%t/mylog%d.log
 * 
 * #daily rotating, in CATALINA_HOME/logs
 * #where CATALINA_HOME is an environment variable
 * com.avaje.lib.log.AuxFileHandler.pattern=${CATALINA_HOME}/logs/mylog%d.log
 * </pre>
 * </code>
 * </p>
 */
