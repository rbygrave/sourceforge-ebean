...
public class MapBeanManagerFactory {
	...
	private final MapBeanPersister persister;
	
	private final JoinTreeFactory joinTreeFactory;

	public MapBeanManagerFactory(PluginDbConfig dbConfig) {
		 persister = new MapBeanPersister(dbConfig);
	...
	public BeanManager<MapBean> create(MapBeanDescriptor desc) {
		...
		//BeanController controller = createController(desc);
