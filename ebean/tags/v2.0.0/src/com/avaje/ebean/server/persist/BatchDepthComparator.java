 ...
 * delays the actually binding to PreparedStatements until the BatchedBeanHolder's
 * are flushed. This is so that we can get the generated keys from inserts.
 * These values are required to persist the 'detail' beans.
 * </p>
 */
