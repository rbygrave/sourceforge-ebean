...
public class GeneratedPropertySettings {
	...
	private void init() {
		...
		// TODO: Add JODA Timestamp types to this list...
		
		// Timestamp, java.util.Date,
		// list of timestamp types used to detect if a property could be
		// used as a Timestamp version property		
	...
	public void setGeneratedProperty(DeployBeanProperty prop) {
		...
		if (propertyType == null) {
			...
			if (prop.isVersionColumn()) {
				...
				// use conventions such as Db column and
				// property names to determine generated
				// properties
	...
	private void setUpdateTimestamp(DeployBeanProperty prop) {
		...
		// we may use a DB Long column as some databases may not
		// store the millis part of a timestamp (e.g. MySql5)
