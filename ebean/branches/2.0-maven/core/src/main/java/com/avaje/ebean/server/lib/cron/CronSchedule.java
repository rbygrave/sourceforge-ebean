...
public class CronSchedule 
{
    ...
    // boolean arrays to help the schedule evaluation.
        ...
        for(int i = 0; tokenizer.hasMoreElements(); i++) {
            ...
            switch(i) {
                ...
                case 5:     // Name of the class       
					//dp("not expecting 5th token");
					//className=token;				
					break;
                    
                case 6:     // Extra Information
					//dp("not expecting 6th token");
                    break;
                default:
                    break;
            }
	...
	public boolean isScheduledToRunNow(Calendar thisMinute) {
        ...
        return ( bHours[thisMinute.get(Calendar.HOUR_OF_DAY)] &&
					bMinutes[thisMinute.get(Calendar.MINUTE)] &&
					bMonths[thisMinute.get(Calendar.MONTH)] &&
					bDaysOfWeek[thisMinute.get(Calendar.DAY_OF_WEEK)-1] &&
					bDaysOfMonth[thisMinute.get(Calendar.DAY_OF_MONTH)-1]);
	}
