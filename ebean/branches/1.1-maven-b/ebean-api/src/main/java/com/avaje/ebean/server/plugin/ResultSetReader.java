...
public class ResultSetReader {
	...
	protected Object getSimpleType(ResultSet rset, int colIndex, int dataType) throws SQLException {
		...
		try {
			...
			case java.sql.Types.DATE:
				//return rset.getDate(colIndex, calendar);
				return rset.getDate(colIndex);

			case java.sql.Types.TIMESTAMP:
				//return rset.getTimestamp(colIndex, calendar);
				return rset.getTimestamp(colIndex);

			case java.sql.Types.TIME:
				//return rset.getTime(colIndex, calendar);
	...
	protected byte[] getBinaryLob(ResultSet rset, int rsetColumn, int fromDataType)
			throws SQLException {
	...
	protected String getStringLob(ResultSet rset, int rsetColumn, int fromDataType)
			throws SQLException {
