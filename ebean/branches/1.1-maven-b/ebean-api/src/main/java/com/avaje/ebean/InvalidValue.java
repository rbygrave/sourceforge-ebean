 ...
 * can also use {@link Ebean#validate(Object)} to validate a bean or
...
public class InvalidValue implements Serializable {
	...
	/**
	 * Returns the attributes of the validator. For example, this is the min,
	 * max of the range validator.
	 * <p>
	 * If there are no attributes (like NotNull) then an empty array is
	 * returned.
	 * </p>
	 * <p>
	 ...
	 * <p>
	 * Note that this is recursive (can follow associated beans or collections)
	 * so some of the children could in fact be other beans with errors
	 * themselves.
	 * </p>
	 */
