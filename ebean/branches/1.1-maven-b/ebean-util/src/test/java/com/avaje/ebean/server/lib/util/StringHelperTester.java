...
/**
 * Test Harness for {@link StringHelper}.
 * @author pmendelson
 * @since Jan, 2009
...
public class StringHelperTester {
	...
	public void testStringParse() {
		String tst="label1='val1' label2=\"val2\"";
		HashMap<String, String> ev = StringHelper.parseNameQuotedValue(tst);
		Reporter.log(tst+"="+ev,true);
		Assert.assertEquals(ev.size(),2);
		Assert.assertEquals(ev.get("label2"),"val2");
	}

	@Test(expectedExceptions=RuntimeException.class)
	public void testInvalidStringParse() {
		String tst="label1=val1' label2=\"val2\"";
		StringHelper.parseNameQuotedValue(tst);
	}
	
	@DataProvider(name="dataCountOccurances")
	public Object[][] dataCountOccurances() {
		String base1 = "abcabcabc";
		return new Object[][] {
				new Object[]{base1,"ca",2},
				new Object[]{base1,"bc",3},
				new Object[]{base1,"z",0},
				new Object[]{base1,base1,1},
				new Object[]{base1,base1+"x",0}
		};
	}
	
	@Test(dataProvider="dataCountOccurances")
	public void testCountOccurances(String content, String occurs, int expected) {
		int actual=StringHelper.countOccurances(content, occurs);
