...
public class ServerConfig {
	...
	TransactionLogging transactionLogging = TransactionLogging.ALL;
	
	TransactionLogSharing transactionLogSharing = TransactionLogSharing.EXPLICIT;
		
	StatementLogLevel insertUpdateDeleteLogLevel = StatementLogLevel.SQL;
	StatementLogLevel findIdLogLevel = StatementLogLevel.SQL;
	StatementLogLevel findManyLogLevel = StatementLogLevel.SQL;
	...
	String databaseBooleanTrue;
	String databaseBooleanFalse;
	
	NamingConvention namingConvention;
	
	boolean updateChangesOnly = true;
